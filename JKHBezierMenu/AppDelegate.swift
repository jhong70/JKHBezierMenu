...
//  JKHBezierMenu
//
//  Created by Joon Hong on 2/21/17.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        centerVC.view.backgroundColor = UIColor.green
        menuVC.view.translatesAutoresizingMaskIntoConstraints = false
        menuVC.view.backgroundColor = UIColor.white
        let menuContainerVC = JKHBezierMenuContainerViewController(withCenterVC: centerVC, menuVC: menuVC)
        
        window?.rootViewController = menuContainerVC
